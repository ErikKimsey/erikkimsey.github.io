...
const LandingContentBannerTemplate = ({ children }) => {
    ...
    return (
        <div className="fixed w-full z-0 top-16 lg:top-0 left-0 w-auto sm:w-full h-full px-0 flex flex-row justify-start items-start lg:justify-end lg:items-center flex-wrap overflow-clip">
            ...
            <div className="z-0 left-0 w-full h-full sm:w-full px-4 pt-20 lg:px-44 flex flex-col justify-start items-start lg:justify-center lg:items-center bg-opacity-70 overflow-clip">
                {children}
            </div>
